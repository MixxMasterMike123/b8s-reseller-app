...
async function main() {
  ...
  for (const [sectionKey, section] of Object.entries(sections)) {
    ...
    console.log(`✅ Created ${fileName} with ${Object.keys(allKeys.reduce((acc, key) => {acc[key.key] = true; return acc;}, {})).length} unique translation keys\n`);
  }
  
  console.log('🎉 All translation CSV files created successfully!');
  console.log('\nNext steps:');
