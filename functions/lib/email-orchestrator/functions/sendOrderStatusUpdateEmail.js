...
exports.sendOrderStatusUpdateEmail = (0, https_1.onCall)({
    ...
    var orchestrator, emailContext, result, error_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!((_a = request.data.orderData) === null || _a === void 0 ? void 0 : _a.orderNumber)) {
                    throw new Error('Order number is required');
                }
                if (!((_b = request.data.userData) === null || _b === void 0 ? void 0 : _b.email)) {
                ...
                return [4 /*yield*/, orchestrator.sendEmail(emailContext)];
            case 1:
                result = _c.sent();
                if (result.success) {
            ...
            case 2:
                error_1 = _c.sent();
                console.error('❌ sendOrderStatusUpdateEmail: Fatal error:', error_1);
                throw new Error(error_1 instanceof Error ? error_1.message : 'Unknown error in status update email');
