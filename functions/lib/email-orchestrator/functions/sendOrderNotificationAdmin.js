...
exports.sendOrderNotificationAdmin = (0, https_1.onCall)({
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                error_1 = _b.sent();
                console.error('❌ sendOrderNotificationAdmin: Fatal error:', error_1);
                throw new Error(error_1 instanceof Error ? error_1.message : 'Unknown error in admin notification email');
