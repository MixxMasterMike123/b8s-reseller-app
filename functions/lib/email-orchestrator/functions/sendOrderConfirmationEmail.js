    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!((_b = request.data.customerInfo) === null || _b === void 0 ? void 0 : _b.email)) {
            ...
            case 2:
                error_1 = _c.sent();
                console.error('❌ sendOrderConfirmationEmail: Fatal error:', error_1);
                throw new Error(error_1 instanceof Error ? error_1.message : 'Unknown error in order confirmation email');
