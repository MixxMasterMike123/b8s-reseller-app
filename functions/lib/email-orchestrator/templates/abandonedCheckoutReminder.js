...
exports.generateAbandonedCheckoutReminderTemplate = void 0;
...
function generateAbandonedCheckoutReminderTemplate(data, lang = 'sv-SE') {
    ...
    const itemRows = (0, emailLayout_1.renderOrderRows)(items.map((it) => {
        ...
        return {
            ...
            meta: it.label
                ? `<span style="font-size:13px;color:#6B7280;">${(0, emailLayout_1.esc)(it.label)}</span>`
                : undefined,
    ...
    const body = (0, emailLayout_1.renderHeading)(en ? 'You left something in your cart' : 'Du glömde något i kassan') +
        ...
        itemRows +
        totalsBlock +
        (0, emailLayout_1.renderButton)(data.recoveryUrl, en ? 'Complete your purchase' : 'Slutför köpet');
...
exports.generateAbandonedCheckoutReminderTemplate = generateAbandonedCheckoutReminderTemplate;
//# sourceMappingURL=abandonedCheckoutReminder.js.map