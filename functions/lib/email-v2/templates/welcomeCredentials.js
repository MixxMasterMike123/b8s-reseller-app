...
exports.getWelcomeCredentialsTemplate = void 0;
// Customer welcome credentials email template
const config_1 = require("../config");
function getWelcomeCredentialsTemplate(data, lang = 'sv-SE') {
    ...
    const loginUrl = `${config_1.APP_URLS.B2B_PORTAL}`;
...
exports.getWelcomeCredentialsTemplate = getWelcomeCredentialsTemplate;
//# sourceMappingURL=welcomeCredentials.js.map