...
exports.getB2BOrderConfirmationAdminTemplate = void 0;
...
function getB2BOrderConfirmationAdminTemplate(data, lang = 'sv-SE') {
    const { userData, orderData, orderSummary, totalAmount } = data;
    const adminPortalUrl = `${config_1.APP_URLS.B2B_PORTAL}/admin/orders`;
    const templates = {
        'sv-SE': {
...
exports.getB2BOrderConfirmationAdminTemplate = getB2BOrderConfirmationAdminTemplate;
//# sourceMappingURL=b2bOrderConfirmationAdmin.js.map