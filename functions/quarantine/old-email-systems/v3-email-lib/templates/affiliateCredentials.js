...
exports.getAffiliateCredentialsTemplate = void 0;
// V3 Affiliate Credentials Email Template
const config_1 = require("../config");
function getAffiliateCredentialsTemplate(data, language = 'sv-SE') {
    const { appData, affiliateCode, tempPassword, wasExistingAuthUser } = data;
    const resetUrl = `${config_1.APP_URLS.PARTNER_URL}/forgot-password`;
    const loginUrl = `${config_1.APP_URLS.PARTNER_URL}/login`;
    const supportUrl = `${config_1.APP_URLS.PARTNER_URL}/contact`;
...
<body>
    <div class="container">
        <div class="header">
            <img src="${config_1.APP_URLS.LOGO_URL}" alt="B8Shield">
        </div>
        ...
        <div class="footer">
            ...
            <p>Visit our partner portal: <a href="${config_1.APP_URLS.PARTNER_URL}">${config_1.APP_URLS.PARTNER_URL}</a></p>
        </div>
    </div>
</body>
</html>`
...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <p>Besök vår partnerportal: <a href="${config_1.APP_URLS.PARTNER_URL}">${config_1.APP_URLS.PARTNER_URL}</a></p>
        </div>
    </div>
</body>
</html>`
...
exports.getAffiliateCredentialsTemplate = getAffiliateCredentialsTemplate;
//# sourceMappingURL=affiliateCredentials.js.map