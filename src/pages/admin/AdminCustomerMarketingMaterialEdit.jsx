  ...
  if (!material || !customer) {
    return (
      <AppLayout>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <p className="text-gray-600">Kundspecifikt material eller kund hittades inte</p>
            <Link
              to="/admin/users"
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-bold text-gray-900">Redigera Kundspecifikt Material</h1>
