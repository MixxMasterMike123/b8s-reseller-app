    ...
    <AppLayout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">Sök kontakt eller se vem du bör kontakta idag</p>
          ...
          <div className="relative max-w-lg mx-auto mb-6">
            ...
            {filteredContacts.length > 0 && (
              ...
              <Link
                  ...
                  >
                    <div className="font-medium text-gray-900 dark:text-gray-100">{contact.companyName}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{contact.contactPerson}</div>
              </Link>
                ))}
              </div>
            )}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 mb-6">
            <div className="flex items-center justify-center space-x-8">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center text-sm text-green-700 dark:text-green-400 font-medium">
                  <span className="w-2 h-2 bg-green-400 dark:bg-green-500 rounded-full mr-1"></span>
                  Aktiva B2B Kunder
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center text-sm text-orange-700 dark:text-orange-400 font-medium">
                  <span className="w-2 h-2 bg-orange-400 dark:bg-orange-500 rounded-full mr-1"></span>
                  CRM Reserveringar
                </div>
              </div>
              <div className="h-8 w-px bg-gray-200 dark:bg-gray-600"></div>
          ...
          <div className="flex items-center justify-center space-x-4 mb-6">
            <Link
              ...
              className="inline-flex items-center px-6 py-3 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white font-medium rounded-xl transition-colors space-x-2"
            >
            ...
            <Link
              ...
              className="inline-flex items-center px-6 py-3 bg-green-600 dark:bg-green-500 hover:bg-green-700 dark:hover:bg-green-600 text-white font-medium rounded-xl transition-colors space-x-2"
            >
          ...
          <Link
            ...
            className="inline-flex items-center px-6 py-3 bg-orange-600 dark:bg-orange-500 hover:bg-orange-700 dark:hover:bg-orange-600 text-white font-medium rounded-xl transition-colors space-x-2"
          >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                ...
                className="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 text-sm font-medium flex items-center"
              >
                Visa alla
            ...
            <div className="space-y-3">
              {!isSwedishBusinessHours() && todaysFollowUps.length === 0 && (
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Mån-Fre 08:00-17:00</p>
                </div>
              )}
              
              {isSwedishBusinessHours() && todaysFollowUps.length === 0 && (
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                  <PhoneIcon className="h-8 w-8 text-gray-300 dark:text-gray-600 mx-auto mb-2" />
              ...
              {todaysFollowUps.map(followUp => {
                ...
                const getUrgencyStyle = (urgency) => {
                  switch(urgency) {
                    case 'critical':
                      return {
                        border: 'border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-900',
                        hover: 'hover:border-red-500 dark:hover:border-red-400 hover:bg-red-100 dark:hover:bg-red-800',
                    ...
                    case 'high':
                      return {
                        border: 'border-orange-200 dark:border-orange-600 bg-orange-50 dark:bg-orange-900',
                        hover: 'hover:border-orange-300 dark:hover:border-orange-500 hover:bg-orange-100 dark:hover:bg-orange-800',
                    ...
                    case 'medium':
                      return {
                        border: 'border-blue-200 dark:border-blue-600 bg-blue-50 dark:bg-blue-900',
                        hover: 'hover:border-blue-300 dark:hover:border-blue-500 hover:bg-blue-100 dark:hover:bg-blue-800',
              ...
              >
                    ...
                    <button
                      ...
                      className="w-full text-center py-2 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 bg-blue-50 dark:bg-blue-900 hover:bg-blue-100 dark:hover:bg-blue-800 rounded-lg transition-colors"
                    >
               ...
               {showDeferred && deferredTriggers.length > 0 && (
                 <div className="mt-4 space-y-2 bg-blue-50 dark:bg-blue-900 rounded-lg p-4">
                   <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Uppskjutna aktiviteter - återkommer automatiskt</h4>
                   <p className="text-xs text-gray-600 dark:text-gray-400 mb-3">Dessa aktiviteter återkommer automatiskt vid bättre tillfälle baserat på svensk affärsrytm.</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              {recentConversations.length === 0 ? (
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                  <ChatBubbleLeftRightIcon className="h-8 w-8 text-gray-300 dark:text-gray-600 mx-auto mb-2" />
                ...
                recentConversations.map((conversation, index) => (
                  <Link
                    ...
                    className="block p-4 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors"
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <div className="font-medium text-gray-900 dark:text-gray-100">{conversation.contact}</div>
