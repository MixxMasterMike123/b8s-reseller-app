...
const ProductIntegrationButton = ({ 
  ...
  const variants = {
    button: {
      className: `inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed ${className}`,
      icon: 'h-4 w-4 mr-2'
    },
    'icon-button': {
      className: `inline-flex items-center p-2 border border-transparent rounded-md text-blue-600 bg-blue-100 hover:bg-blue-200 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed ${className}`,
      icon: 'h-5 w-5'
    },
    'toolbar-button': {
