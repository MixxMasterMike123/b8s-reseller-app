...
export const getFileIcon = (fileType) => {
  // Return icon names for Heroicons - components will render the actual icons
  const icons = {
    'image': 'photo',           // PhotoIcon
    'video': 'video-camera',    // VideoCameraIcon  
    'document': 'document-text', // DocumentTextIcon
    'archive': 'archive-box',   // ArchiveBoxIcon
    'other': 'paper-clip'       // PaperClipIcon
  };
