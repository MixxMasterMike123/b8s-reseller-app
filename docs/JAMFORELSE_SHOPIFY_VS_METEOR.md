...
| **Produktrecensioner** | ❌ app: Judge.me $15/mån | ✅ **inbyggd** (add-on, 2026-07-06): egen insamling från verifierade köp — automatisk e-postförfrågan efter leverans, stjärnor + text, moderering, aggregerat betyg på produktsidan, Google-stjärnor (JSON-LD), Omnibus-kompatibel äkthetsdeklaration. Trustpilot-widget finns kvar som alternativ |
...
- **Luckor att stänga innan tabellen används publikt:** egen domän, native Swish (blockerat av Stripes onboarding-paus — väntelista), produkt-/kundexport, presentkort, EUR-debitering (visningen finns), engelsk butik (infran finns).
- **Add-on-arsenalen är större än Shopify-jämförelsen antydde:** affiliate, B2B-grossistportal med fakturaorder, kampanjer, ambassadörs-CRM, sälj-CRM, AI-produkttexter, rabattkoder/kampanjkoder (2026-07-05), övergiven kassa-påminnelse (2026-07-06), produktrecensioner från verifierade köp (2026-07-06), POD med lokalt tryckeri (serversäkrad produktionspipeline, planerad). Hos Shopify är varje rad en app à $15–50/mån — utom rabattkoder och övergiven kassa som ingår i Basic, där vi nu har paritet i stället för lucka. Detta är Kents add-on-tes i siffror — det som saknas är fortfarande betalmekanismen för modulerna.
