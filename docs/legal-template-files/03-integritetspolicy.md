...
> ► BESLUT (granskas av jurist, ta bort denna ruta): Denna policy är skriven utifrån att **säljaren
> är personuppgiftsansvarig** för kunddata och att plattformen är personuppgiftsbiträde. Bekräfta
> att det är den modell ni vill ha. Är plattformen i stället gemensamt eller ensamt ansvarig ändras
> policyn i grunden.
